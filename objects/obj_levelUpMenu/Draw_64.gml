...
for (var row = 0; row < total_rows; row++) {
    ...
    if (row == 0) {
        ...
        draw_text(button1_x + upgrade_button_width / 2, text_y + line_spacing * 2, string(upgrade1_rank + 1) + "/5");
        ...
        draw_text(button2_x + upgrade_button_width / 2, text_y + line_spacing * 2, string(upgrade2_rank + 1) + "/5");
        ...
        draw_text(button3_x + upgrade_button_width / 2, text_y + line_spacing * 2, string(upgrade3_rank + 1) + "/5");
    } else {
        // Placeholder rows

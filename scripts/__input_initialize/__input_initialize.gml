...
function __input_initialize()
{
    ...
    //Global frame counter and realtime numberer. This is used for input buffering
    _global.__frame = 0;
    ...
    //Arrays/dictionaries to number basic verbs and chords
    ...
    if (INPUT_IGNORE_RESERVED_KEYS_LEVEL > 1)
    {
        ...
        if (INPUT_ON_WEB || __INPUT_ON_WINDOWS)
        {
            ...
            input_ignore_key_add(0xB0); //Next number
            input_ignore_key_add(0xB1); //Previous number
